...
-- 
 ...
 define AGGONE= text({"sum",1},{"min",1},{"max",1},{"avg",1},{"stdev",1}); -- for qualification min
 define AGGTWO= text({"sum",1},{"min",1},{"max",1},{"avg",1},{"stdev",1}); -- for qualification max
 define AGGTHREE= text({"sum",1},{"min",1},{"max",1},{"avg",1},{"stdev",1}); -- for qualification avg
 define _LIMIT=100;
